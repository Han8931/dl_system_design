...
\include{./sections/data_engineering}
\part{Training LLMs}
\include{./sections/train_llm}
\include{./sections/peft}
\part{LLM Services}
\include{./sections/services/llm_services}
\part{RAG}
\include{./sections/rag/rag}
\part{Prompt Engineering}
\include{./sections/prompts/prompt_engineering}
\part{A Systems View for LLMs}
\include{./sections/hardware/gpus}
\include{./sections/hardware/model_efficiency}
\part{LLM Inference}
\include{./sections/transformers/transformer}
\include{./sections/transformers/flash_attn}
\part{Parallelism}
\input{./sections/parallelism/parallelism}
\part{On-Device AI}
\include{./sections/on_device/on_device}
\part{Compression}
\include{./sections/compression/compression}
